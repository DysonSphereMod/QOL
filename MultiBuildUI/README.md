...
![MultiBuildUI](https://github.com/DysonSphereMod/QOL/blob/master/MultiBuildUI/screenshot.jpg?raw=true)
> In this screenshot you can see [MultiBuildUI](https://dsp.thunderstore.io/package/brokenmass/MultiBuildUI/) , [CopyInserters](https://dsp.thunderstore.io/package/thisisbrad/CopyInserters/) and [BuildCounter](https://dsp.thunderstore.io/package/brokenmass/BuildCounter/);
...
Select a building from the building bar or copy an exisiting building, then press `LEFT ALT` keyboard button to enter MultiBuildUI mode.
...
### v1.1.2
- Fix incompatibility issue with CopyInserters where inserters were not being copied when in MultiBuildUI mode

### v1.1.1
- Fix a bug where the build preview disappears and the game reports "building out of range", if, when in MultiBuildUI mode, only a single copy of the building is placed.
